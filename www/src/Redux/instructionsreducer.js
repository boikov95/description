...
const SEARCH = "SEARCH";
const SET_COUNTRYID = "SET_COUNTRYID";
...
export const setCountryId = (id) => ({ type: SET_COUNTRYID, id });
...
export const loadTeg = () => async (dispatch) => {
...
export const loadInstructions = (where) => async (dispatch) => {
...
export const addInstructionsNew = (where) => async (dispatch) => {
  let data = await API.loadInstructions(where);
  if (data.code === "success") {
